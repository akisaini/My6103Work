...
#Converting happiness to numeric:
...
# We can observe that the mean hrs worked is nearly the same for all the categories of marital status. 
# %%
...
#Conclusion or Summary: People who are 'not too happy' had children in the same range as compared to people who are 'very happy'. 
# %%
